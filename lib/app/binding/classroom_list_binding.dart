...
import 'package:politech_manager/app/controller/classroom_list_controller.dart';
...
class ClassroomListBinding extends Bindings {
  ...
  void dependencies() {
    ...
    Get.lazyPut(() => ClassroomListController(dataRepository: Get.find(), errorManager: Get.find()));
  }

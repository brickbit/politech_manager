...
import 'package:politech_manager/app/controller/create_schedule_controller.dart';
...
class CreateScheduleBinding extends Bindings {
  ...
  void dependencies() {
    ...
    Get.lazyPut(() => CreateScheduleController(dataRepository: Get.find(), errorManager: Get.find()));
  }

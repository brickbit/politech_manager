...
import 'package:politech_manager/app/controller/subject_list_controller.dart';
...
class SubjectListBinding extends Bindings {
  ...
  void dependencies() {
    ...
    Get.lazyPut(() => SubjectListController(dataRepository: Get.find(), errorManager: Get.find()));
  }

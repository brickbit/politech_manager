...
import 'package:politech_manager/app/binding/create_calendar_binding.dart';
...
import 'package:politech_manager/app/views/screens/create_calendar_screen.dart';
...
class AppPages {
  ...
  GetPage(
    ...
    GetPage(
      ...
      page: () => const CreateCalendarScreen(),
